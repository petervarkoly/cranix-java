...
public class UserResource {
    ...
    public CrxResponse importUser(
        ...
        if (password != null && !password.isEmpty()) {
            ...
            Boolean checkPassword = uc.getConfigValue("CHECK_PASSWORD_QUALITY").equalsIgnoreCase("yes");
    ...
    @ApiOperation(
            ...
            "<li> delete Delete the users." +
            "<li> setPassword" +
                    "<li> removeProfiles Removes the Windows profile directory." +
                    "<li> disableLogin" +
                    "<li> enableLogin" +
                    "<li> disableInternet Disable surfing via proxy" +
                    "<li> enableInternet Enable surfing via proxy" +
                    "<li> mandatoryProfile Make the users windows profile mandatory (read only)" +
                    "<li> rwProfile Make the users windows profile writable" +
                    "<li> copyTemplate Apply the role based template to the user" +
                    "<li> setFilesystemQuota Set filesystem quota" +
                    "<li> setMailsystemQuota Set mail system quota")
    @ApiResponses(value = {
            @ApiResponse(code = 500, message = "Server broken, please contact administrator")})
    @RolesAllowed("user.manage")
